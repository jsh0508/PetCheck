...
<body>
	<c:if test="${!empty mvo}">
	<h1>우리아이 추가 등록</h1>
	<h3>어떤 반려동물을 키우고 계시나요?</h3>
		<form id="addPet" action="${cpath}/insertPet.do" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<label><div class="insertDog"></div><input type="radio" name="pet_race" value="강아지">강아지</label>
				<label><div class="insertCat"></div><input type="radio" name="pet_race" value="고양이">고양이</label>
			</div>
			<br>
			<div class="form-group">
				<label for="detail_race">상세품종 :</label>
				<input type="text" name="detail_race">
			</div>
			<br>
			<div class="form-group">
