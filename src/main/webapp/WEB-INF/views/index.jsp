                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container"
                            ...
                            <ul class="navbar-nav navbar-nav-right">
                                ...
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="${cpath}/login1.do">로그인</a></li>
                                <li class="nav-item"><a class="nav-item-child nav-item-hover" href="about.html">회원가입</a></li>
